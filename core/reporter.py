...
class Reporter:
    ...
    def _set_config(self):
        ...
        self._logger.debug(f"formatted milestone: {self._fmilestone}")

        prof = self._config['prof']
        self._logger.debug(f"professor: {prof}")
        ...
        self.repos = util.get_dirs(self._repo_root)
    ...
    def check_build_out_m2(self, lines):
        if self._config['prof'] == "hugh":
            ...
            #testcase2
                ["testCase2:", "Index:", 0, [902]],
                ["testCase2:", "Index:", 2, [101]],
                ["testCase2:", "Index:", 3, [102]],
                ["testCase2:", "Index:", 5, [808]],
                ["testCase2:", "Index:", 6, [402, 303]],
                ["testCase2:", "Index:", 7, [502]],
                ["testCase2:", "Index:", 8, [602]],
            #testcase3
            ...
            #testcase5
                ["testCase5:", "Index:", 1, [34, 67, 23]],
                ["testCase5:", "Index:", 3, [80]],
                ["testCase5:", "Index:", 9, [9, 86, 53, 42]],
            ]
    ...
    def _report(self):
        ...
        for repo in self.repos:
            if repo == '/report':
                print('Reporter: _report: Skipped `report` directory.')
                continue
            ...
            cmd = (
                f'cd {path} && ' +
                r'echo $(git log -n 1 --pretty=format:"%ad %h %an %s" --date=format:"%m/%d/%y %I:%M %p") && ' +
                f'cd -'
            )
