...
class TestBuild(unittest.TestCase):
    ...
    def test_find_msbuild_not_found(self, mock_getenv, mock_os_walk):
    ...
    def test_find_sln_path_success(self, mock_subprocess, mock_find_msbuild):
        ...
        print(f"mock ret: {mock_subprocess.return_value.stdout}")
    ...
    #    @patch('core.build.Build._find_msbuild',
    #           return_value=r"C:\Program Files\msbuild.exe")
    #    def test_make_run_windows_success(self, mock_subprocess, mock_find_msbuild):
